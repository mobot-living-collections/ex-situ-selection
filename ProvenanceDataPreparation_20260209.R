...
## of Quercus arkansana (Fagaceae) maintained in the Plant Nursery of the MBG.
## 
##
## DATA FILES REQUIRED
##
...
Qa.sd <- read.table("QaSurDat_2025Sep02_135300.csv", header = T, sep = ",")
dim(Qa.sd) 
str(Qa.sd) 
head(Qa.sd)
...
#extract accession provenance data for MBG accessions of Q. arkansana
...
#of the accessions in the common garden.
#windows(14,14)
