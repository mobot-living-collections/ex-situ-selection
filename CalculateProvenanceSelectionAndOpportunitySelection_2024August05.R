...
#plot number of maternal lines for each provenace ((i.e., geographic region)in the horizontal axis
...
hist(null.opportunity.for.selection.region2, breaks=seq(0, 0.6, 0.01),
	main="Region 2", col.main="#D81B60", xlab=expression(paste("Opportunity for selection (", italic(I[2]), ")", sep="")),
	ylab="Null model iterations", font.main=1, cex.main=1.5, cex.axis=1.5, cex.lab=1.5,
	border="gray", col="gray90")
#add observed value
abline(v=observed.opportunity.for.selection.region2, col="black", lty=1, lwd=2)

#add legend
legend("topright", c("Observed", "Null model"), fill=c(NA, "gray90"), border=c(NA, "gray"))
#add symbol for observed value, a bit fidgety
arrows(0.504, 630, 0.504, 647, length=0, angle=90, col="black", lwd=2)
...
hist(null.opportunity.for.selection.region3, breaks=seq(0, 4, 0.1),
	main="Region 3", col.main="#1E88E5", xlab=expression(paste("Opportunity for selection (", italic(I[3]), ")", sep="")),
	ylab="Null model iterations", font.main=1, cex.main=1.5, cex.axis=1.5, cex.lab=1.5,
	border="gray", col="gray90")
#add observed value
abline(v=observed.opportunity.for.selection.region3, col="black", lty=1, lwd=2)

#add legend
legend("topright", c("Observed", "Null model"), fill=c(NA, "gray90"), border=c(NA, "gray"))
#add symbol for observed value, a bit fidgety
arrows(3.35, 5200, 3.35, 5400, length=0, angle=90, col="black", lwd=2)
...
hist(null.opportunity.for.selection.region4, breaks=seq(0, 1.2, 0.01),
	main="Region 4", col.main="#FFC107", xlab=expression(paste("Opportunity for selection (", italic(I[4]), ")", sep="")),
	ylab="Null model iterations", font.main=1, cex.main=1.5, cex.axis=1.5, cex.lab=1.5,
	border="gray", col="gray90")
#add observed value
abline(v=observed.opportunity.for.selection.region4, col="black", lty=1, lwd=2)

#add legend
legend("topright", c("Observed", "Null model"), fill=c(NA, "lightblue"), border=c(NA, "blue"))
#add symbol for observed value, a bit fidgety
arrows(1.01, 495, 1.01, 510, length=0, angle=90, col="red", lwd=2)
...
hist(null.opportunity.for.selection.region5, breaks=seq(0, 0.85, 0.01),
	main="Region 5", col.main="#42FD7F", xlab=expression(paste("Opportunity for selection (", italic(I[5]), ")", sep="")),
	ylab="Null model iterations", font.main=1, cex.main=1.5, cex.axis=1.5, cex.lab=1.5,
	border="gray", col="gray90")
#add observed value
abline(v=observed.opportunity.for.selection.region5, col="black", lty=1, lwd=2)

#add legend
legend("topright", c("Observed", "Null model"), fill=c(NA, "lightblue"), border=c(NA, "blue"))
#add symbol for observed value, a bit fidgety
arrows(0.672, 473, 0.672, 488, length=0, angle=90, col="red", lwd=2)
