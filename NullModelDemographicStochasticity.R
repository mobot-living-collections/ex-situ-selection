...
legend(16.5 * (1 + 0.2), 11, paste("Maternal lines region", c(2, 3, 4, 5, 8)),
       fill = viridis(n = length(unique(Qa.prov.data$GeographicRegion)), option = "D"), cex = 1)
...
#add legend
legend(5*(2+0.5), 11, "Demographic stochasticity null model", pch=NA, cex=1)
#add symbol (a bit fidgety)
arrows(14, 10.1, 14, 10.8, length=0.01, angle=90, code=3, col="black")
